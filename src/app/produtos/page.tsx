            ...
            <div className="divide-y divide-zinc-200">
              {products.map((product) => (
                ...
                >
                  ...
                  <div>
                    {product.badge ? <span className="rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-xs font-medium text-primary">{product.badge}</span> : <span className="text-sm text-zinc-400">-</span>}
                  </div>

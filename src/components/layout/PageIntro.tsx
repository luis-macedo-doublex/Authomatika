...
export function PageIntro({ tag, title, subtitle, breadcrumbs }: PageIntroProps) {
  ...
  return (
    <section className="relative overflow-hidden border-b border-zinc-200 bg-white pt-24 pb-14 md:pt-28 md:pb-18">
      {/* Subtle grid */}
      <div className="page-grid absolute inset-0 opacity-40 pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8">
        {/* Breadcrumb */}
        {hasBreadcrumbs ? (
          <nav aria-label="Breadcrumb" className="mb-8 flex flex-wrap items-center gap-1.5 text-xs text-zinc-400">

        ...
        <div className="flex flex-1 flex-col lg:grid lg:grid-cols-[1fr_360px]">
          ...
          <div className="flex flex-col justify-end border-zinc-800/50 px-5 pb-12 pt-28 sm:px-8 lg:border-r lg:px-16 lg:pb-16 lg:pt-32">
            <div className="max-w-3xl">
              ...
              {/* Stacked headline — 3 distinct color lines */}
              <h1 className="mb-8 font-display font-bold leading-[0.95] tracking-[-0.04em]">
                <span className="block text-[clamp(2.75rem,6.5vw,6rem)] text-zinc-500">Elétrica.</span>
                <span className="block text-[clamp(2.75rem,6.5vw,6rem)] text-zinc-200">Automação.</span>
                <span className="block text-[clamp(2.75rem,6.5vw,6rem)] text-primary">EPC.</span>
              </h1>

              <p className="mb-10 max-w-lg text-lg leading-relaxed text-zinc-400">
                {company.description}. Projetos de alta exigência com responsabilidade de ponta a ponta.
              </p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <Link href="/empresa/institucional">
                    Sobre a empresa <ArrowUpRight className="size-4" />
                  </Link>
                </Button>
              </div>
            </div>
